...
![Hotstring example gif 0](help/Hotstring example gif 0.gif)

Below is an example of a hotlist being used on the command line:

![Hotlist example gif 0](help/Hotlist example gif 0.gif)
...
#### [Edit-CustomHotlist](help/Edit-CustomHotlist.md)
...
![Hotlist example gif 1](help/Hotlist example gif 1.gif)
...
![Hotlist example gif 2](help/Hotlist example gif 2.gif)
...
![Hotlist example gif 3](help/Hotlist example gif 3.gif)
